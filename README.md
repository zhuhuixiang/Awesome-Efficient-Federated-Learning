...
A curated list of **Efficient Federated Learning** and **Personalized Federated Learning** publications, which focus on reducing communication/computation/inference cost, in Top-tier Conference, included **ICML, NeurIPS, AAAI, Infocom, etc.**
## Contributing
