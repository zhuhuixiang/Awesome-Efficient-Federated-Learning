...
A curated list of **Efficient Federated Learning** and **Personalized Federated Learning** publications, which focus on reducing communication/computation/inference cost, in Top-tier Conference, included **ICML, NeurIPS, AAAI, etc.**
## Contributing
...
| [Federated Multi-Task Learning under a Mixture of Distributions](https://openreview.net/forum?id=YCqx6zhEzRp)  | INRIA | Non-I.I.D, Personalization | Surrogate Optimization Algorithms |
