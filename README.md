...
A curated list of **Efficient Federated Learning** and **Personalized Federated Learning** publications in Top-tier Conference, included **ICML, NeurIPS, AAAI, ICLR, CVPR, INFOCOM, etc.** We promise to update the list every month.
## Contributing
